...
type AppStore = {
  ...
  setThingsLoading: (loading: boolean) => void
  setMutatingThing: (mutating: boolean) => void
...
export const useAppStore = create<AppStore>((set) => ({
  ...
  setThingsLoading: (loading) => set({ isThingsLoading: loading }),
  setMutatingThing: (mutating) => set({ isMutatingThing: mutating }),
  ...
  openEditModal: (thing) =>
    set({ isEditModalOpen: true, selectedThing: thing }),
  closeEditModal: () => set({ isEditModalOpen: false, selectedThing: null }),
  openDeleteModal: (thing) =>
    set({ isDeleteModalOpen: true, selectedThing: thing }),
